...
<section class="py-8 z-10 font-serif">
    <div class="flex flex-col md:flex-row items-center max-w-6xl px-6 py-8 mx-auto">
        <div class="w-full md:w-1/2 py-8">
            <h1 class="text-purple-900 text-7xl font-semibold leading-none tracking-tighter">
                Welcome to<br><span class="text-blue-500"> Subscription API <br></span> Platform
            </h1>
        </div>
        <div class="w-full md:w-1/2 py-8">
    ...
    <div class="w-full items-center flex flex-col gap-2">
        <h1 class="text-4xl font-semibold text-start leading-none tracking-tighter p-2">Postman workspace ID: <span
                class="rounded-sm bg-orange-500 text-gray-50 p-2">f6f6be1c-4be7-4157-82c9-259de0b13abe</span></h1>
        <h1 class="text-4xl font-semibold text-start leading-none tracking-tighter p-2">GitHub repo URL: <span
                class="rounded-sm bg-purple-950 text-gray-50 p-2">https://github.com/Var-Hovhannisyan/SubscribtionPlatformAPI</span></h1>
    </div>
</section>
